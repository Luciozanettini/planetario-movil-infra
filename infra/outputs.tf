...
output "stats_api_endpoint" {
  description = "URL del endpoint de estadisticas. Hay que pegar este valor en la constante STATS_API_URL del <script> de site/panel.html, y volver a aplicar."
  value       = "${aws_apigatewayv2_api.leads.api_endpoint}/stats"
}